...
object ModelGenerators {
  ...
  val optionGen: Gen[Options] = for {
    ...
    outputMode <- Gen.option(Gen.oneOf(OutputMode.InRepo, OutputMode.ExternalRepo))
  ...
  } yield Options(vcp, dir, langs, res, trans, heads, cache, prefix, licenses, resolverType, outputMode, strictVisibility, buildFileName)
